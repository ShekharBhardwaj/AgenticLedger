...
| Azure OpenAI | library azure_endpoint | [azure-openai.md](azure-openai.md) |
| AWS Bedrock | direct InvokeModel capture (the ledger signs with its own AWS credentials), or via gateway | [bedrock.md](bedrock.md) |
